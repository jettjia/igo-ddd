...
import (
	...
	entity "github.com/jettjia/GasPc/domain/entity/user"
	repoMock "github.com/jettjia/GasPc/domain/irepository/sys/mock"
	"github.com/jettjia/GasPc/types"
)
...
func Test_FindSysMenuById(t *testing.T) {
	...
	Convey("Convey Test FindSysMenuById", t, func() {
		Convey("FindSysMenuById Success", func() {
			...
			assert.Equal(t, errRsp, err)
			assert.Equal(t, sysMenuEnRsp.MenuId, id)
		})
	})
}
